...
describe('User Reducer - updateUser', () => {
  ...
  it('should handle updateUser.fulfilled', () => {
    const mockUpdatedUser = { id: '123', name: 'Updated User', email: 'updated@example.com' }; // Пример обновленных данных пользователя
    const action = { type: updateUser.fulfilled.type, payload: mockUpdatedUser };
